        ...
        <div className="container mx-auto max-w-4xl px-4 space-y-8">
          ...
          <section className="space-y-2">
            ...
            <div className="rounded-xl border border-border/60 bg-card overflow-hidden">
              <iframe
                title="CGP Garages PitStop"
                src="/api/legal-doc?doc=cgp"
                className="h-[80vh] w-full"
              />
            </div>
            <p className="text-sm text-muted-foreground">
              Si l&apos;aperçu ne s&apos;affiche pas, ouvrez le PDF directement :{" "}
              <a className="text-primary hover:underline" href="/api/legal-doc?doc=cgp" target="_blank" rel="noreferrer">
                Télécharger / Ouvrir les CGP garages
              </a>
              .
            </p>
          </section>
