...
Article 1 — Parties
Les présentes Conditions Générales de Partenariat (ci-après « CGP B2B ») régissent les relations
entre :
...
3.2 Le Garage est l’unique prestataire d’exécution des services techniques (diagnostic atelier,
réparation, remplacement, entretien, etc.).
3.3 Le Garage assume l’entière responsabilité professionnelle, technique, assurantielle, légale et
réglementaire de ses prestations.
...
5.1 Le Garage s’engage à maintenir une cohérence raisonnable avec les fourchettes présentées via
PitStop, lorsque l’état réel du véhicule le permet.

-- 1 of 4 --

5.2 En cas d’écart, le Garage s’engage à fournir au Client une justification claire, précise et
argumentée (ex. avarie cachée, usure structurelle, opération complémentaire indispensable).
5.3 PitStop promeut une relation de confiance : transparence du devis, pédagogie client, traçabilité
des explications.
...
• retard >45 min avec information : acompte conservé, intervention possible à la discrétion du
Garage.
6.3 Le Garage conserve la faculté de justifier la conservation de l’acompte lorsque des coûts de
préparation réels ont été engagés.
...
9.2 Les données reçues via PitStop ne peuvent être utilisées par le Garage qu’aux fins d’exécution
des services convenus.

-- 2 of 4 --

9.3 Les parties s’obligent à préserver la confidentialité des informations commerciales, techniques
et clients échangées.
Article 10 — Propriété intellectuelle
10.1 PitStop conserve l’ensemble des droits sur la plateforme, ses marques, interfaces, contenus,
outils, bases et éléments distinctifs.
...
11.2 PitStop n’est pas responsable de la mauvaise exécution de la prestation mécanique par le
Garage.
11.3 Le Garage n’est pas responsable des indisponibilités techniques imputables exclusivement à
PitStop, sauf faute prouvée du Garage dans l’usage des outils.
Article 12 — Fraude, abus, atteinte à l’image
En cas de fraude, pratiques commerciales trompeuses, atteinte à l’image de PitStop, non-conformité
grave ou comportement déloyal, PitStop peut suspendre ou résilier le partenariat, sans préjudice des
...
13.2 Il peut être suspendu/résilié en cas de manquement grave ou répété, après notification, sauf
urgence ou gravité particulière justifiant effet immédiat.
Article 14 — Preuve électronique
Les échanges électroniques, journaux techniques, horodatages, confirmations et enregistrements
informatiques constituent des éléments de preuve recevables entre les parties jusqu’à preuve
contraire.
Article 15 — Force majeure
Aucune partie ne sera tenue responsable d’un retard ou d’une inexécution causés par un cas de force
majeure au sens du droit belge.
...
Article 17 — Cession
Le Garage ne peut céder tout ou partie de ses droits/obligations au titre des présentes sans accord
préalable écrit de PitStop.
Article 18 — Modification des CGP B2B
PitStop peut modifier les CGP B2B à tout moment.
Les nouvelles versions sont portées à la connaissance du Garage et s’appliquent selon les modalités
contractuelles convenues.
Article 19 — Droit applicable et litiges
19.1 Les CGP B2B sont soumises au droit belge.
19.2 Les litiges relèvent de la compétence des juridictions de Nivelles, sauf disposition impérative
contraire.
