        ...
        <div className="container mx-auto max-w-4xl px-4 space-y-8">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-1">
              ...
              <li>Contact : <a className="text-primary hover:underline" href="mailto:pitstopbelgique@gmail.com">pitstopbelgique@gmail.com</a></li>
            </ul>
            <p className="text-muted-foreground">Ci-après dénommé « PitStop ».</p>
            <p className="text-muted-foreground">
              Ces informations (numéro BCE, numéro de TVA, forme juridique) seront mises à jour lors du passage en exploitation commerciale officielle.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              <br />
              4.2 PitStop ne réalise pas directement les interventions mécaniques, carrosserie, entretien ou réparation. Le garage partenaire demeure le seul prestataire d&apos;exécution.
              <br />
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">6.1 1 crédit = 1 diagnostic automobile complet sur la plateforme, incluant les éventuelles questions de suivi dans le parcours du diagnostic.</p>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-1">
              <li><span className="font-medium text-foreground">Réception &amp; qualification</span> : PitStop enregistre la demande et qualifie la nature du litige (paiement, acompte, no-show, annulation, écart de devis, etc.).</li>
              <li><span className="font-medium text-foreground">Instruction contradictoire</span> : si un garage est impliqué, PitStop peut recueillir ses éléments (chronologie, justificatifs, preuves de contact, etc.).</li>
              <li><span className="font-medium text-foreground">Décision motivée</span> : confirmation de la règle appliquée, régularisation totale/partielle, ou proposition amiable.</li>
              <li><span className="font-medium text-foreground">Clôture</span> : le dossier est clôturé avec conservation des éléments de preuve selon les obligations légales applicables.</li>
            </ul>
            <p className="text-muted-foreground">
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              PitStop se réserve le droit de modifier les présentes CGV à tout moment. La version opposable est celle en vigueur à la date de l&apos;acte concerné (achat, réservation, usage).
            </p>
          </section>
