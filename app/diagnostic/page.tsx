      ...
      <main>
        <section className="relative overflow-hidden py-14 md:py-20">
          ...
          <div className="container mx-auto max-w-6xl px-4 relative">
            ...
            <div className="flex justify-center max-w-3xl mx-auto mb-8 md:mb-10">
              <div className="inline-flex max-w-full items-center justify-center gap-1.5 px-2 py-1.5 sm:gap-2 sm:px-4 sm:py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-[12px] font-medium leading-tight whitespace-nowrap sm:text-sm sm:leading-normal text-center">
