...
export const metadata: Metadata = {
  title: "SLA — PitStop",
  description: "Annexe SLA PitStop.",
}
...
1) Objet
Le présent SLA définit les niveaux de service cibles de la plateforme PitStop (disponibilité,
incidents, délais de prise en charge, maintenance, communication) pour les parcours actifs du site.
...
• la disponibilité d’infrastructures tierces (Stripe, hébergeur, DNS, réseau mobile/opérateur,
services Google, etc.) ;
• les interruptions dues à la force majeure ;
• les indisponibilités causées par des actions malveillantes externes ou par une mauvaise
...
En cas de faille sécurité, risque de corruption des données ou indisponibilité critique, PitStop peut
intervenir sans préavis.

-- 1 of 3 --

5) Classification des incidents
• P1 (Critique) : indisponibilité complète du service principal, paiement impossible, panne
bloquante généralisée.
• P2 (Majeur) : fonctionnalité centrale indisponible pour une partie significative des
utilisateurs.
...
Les délais de résolution dépendent de la cause racine, de la complexité technique et des
dépendances tierces.
...
Aucun niveau de service ne peut être opposé pour des causes externes hors contrôle raisonnable de
PitStop.

-- 2 of 3 --

11) Révision du SLA
PitStop peut adapter le présent SLA pour raisons techniques, légales ou de sécurité, avec publication
