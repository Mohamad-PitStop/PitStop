...
export function HomeAnimatedBackground() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-1/2 top-[42%] [transform:translate3d(-50%,-50%,0)]">
      ...
      <div className="home-aurora-vignette absolute inset-0 bg-[radial-gradient(ellipse_95%_85%_at_50%_28%,transparent_0%,transparent_42%,rgb(13_27_62/0.72)_88%)] [transform:translateZ(0)] [pointer-events:none]" />
    </div>
  )
}
