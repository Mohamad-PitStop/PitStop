export const enAuth = {
  ...
  complete: {
    ...
    mandatoryWarning:
      "Your signup is not yet complete. No account is created until you save — if you leave this page, you will need to start over from scratch.",
    sessionExpired:
      "Your signup session has expired. Start again with Google to finish.",
    emailAlreadyUsed:
